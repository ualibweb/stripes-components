...
class PaneHeader extends Component {
  static propTypes = {
    actionMenuItems: PropTypes.oneOfType([
  ...
  getActionMenu() {
    ...
    console.group();
      console.log('actionMenuItems function', actionMenuItems instanceof Function);
      console.log('actionMenuItems array', actionMenuItems instanceof Array);
    console.groupEnd();
     ...
     * Custom action menu
     */
    if (actionMenuItems instanceof Function) {
      const props = {
        toggleMenu: this.toggleActionMenu,
      };

      return actionMenuItems(props);
    }

    /**
     * Action Menu defined as array of objects
     */
    if (actionMenuItems instanceof Array && actionMenuItems.length) {
      return (
        <Menu>
          <MenuSection>
            <NavList>
